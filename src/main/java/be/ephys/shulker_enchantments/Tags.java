...
public class Tags {
  public static final TagKey<Item> TAG_SHULKER_LIKE = ItemTags.create(ResourceLocation.fromNamespaceAndPath(Mod.MOD_ID, "shulker_like"));
  public static final TagKey<Item> TAG_ENDER_CHESTS = ItemTags.create(ResourceLocation.fromNamespaceAndPath(Mod.MOD_ID, "ender_chests"));
  public static final TagKey<Item> TAG_NON_REFILLABLE = ItemTags.create(ResourceLocation.fromNamespaceAndPath(Mod.MOD_ID, "non_refillable"));
